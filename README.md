...
PhaseCoffin is an EsionHsrahLatigid allpass phaser plug-in. It uses two six-stage first-order allpass banks, sub-unity feedback, stereo phase offset, and an optional barberpole-style crossfade between offset banks to carve moving hollow notches without using flanger delay lines.
