...
namespace
{
class PhaseCoffinStandaloneApplication final : public juce::JUCEApplication
{
public:
    PhaseCoffinStandaloneApplication()
    {
...
START_JUCE_APPLICATION(PhaseCoffinStandaloneApplication)
